...
public class JWTUtil {
    ...
    private static final int loginTokenLiveTime = 1000 * 3600; // 1-day
    ...
    public static String encodeForEmail(Integer profileId) {
        ...
        jwtBuilder.signWith(secretKeySpec);
        jwtBuilder.claim("id", profileId);
        jwtBuilder.expiration(new Date(System.currentTimeMillis() + (loginTokenLiveTime)));
        jwtBuilder.issuer("KunUzTest");
        return jwtBuilder.compact();
    }
